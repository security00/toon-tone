...
export default function Home() {
  return (
    <main className="min-h-screen bg-[radial-gradient(circle_at_top_left,#fde68a,transparent_30%),linear-gradient(135deg,#fff7ed_0%,#fef3c7_45%,#fce7f3_100%)] px-4 py-5 text-slate-950 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-7xl">
        ...
        <section className="mt-10 grid gap-5 lg:grid-cols-[1fr_0.8fr]">
          <article className="rounded-[2rem] border-4 border-slate-950 bg-white/85 p-6 shadow-[8px_8px_0_#0f172a]">
          ...
          <aside className="rounded-[2rem] border-4 border-slate-950 bg-slate-950 p-6 text-white shadow-[8px_8px_0_#0f172a]">
            <h2 className="text-2xl font-black">MVP question bank</h2>
            <p className="mt-3 leading-7 text-slate-300">{QUESTIONS.length} text-reference-only questions. No official character images, screenshots, logos, audio, or video are used.</p>
        ...
        <section className="mt-10 rounded-[2rem] bg-white/70 p-6">
          <h2 className="text-2xl font-black">FAQ</h2>
          <div className="mt-4 grid gap-4 md:grid-cols-2">
            {[
              ["Is Toon-Tone free?", "Yes. The Daily Challenge is free and does not require login."],
              ["Do you use official cartoon images?", "No. MVP questions use text references and abstract color UI only."],
